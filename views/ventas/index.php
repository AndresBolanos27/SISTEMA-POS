...
<div class="card custom-card-table">
    <div class="card-body card-body-custom">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-ventas" role="tabpanel" aria-labelledby="nav-ventas-tab" tabindex="0">
                ...
                <div class="row mb-2">
                    ...
                    <!-- <div class="col-md-3">
                        <div class="btn-group-toggle float-end" data-toggle="buttons">
                            <label class="btn btn-primary">
                                <input type="checkbox" id="impresion_directa" checked> Impresión Directa </input>
                            </label>
                        </div>
                    </div> -->
                </div>
            ...
            <div class="tab-pane fade p-3" id="nav-historial" role="tabpanel" aria-labelledby="nav-historial-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table  table-striped table-hover align-middle nowrap" id="tblHistorial" style="width: 100%;">
                        <thead>
                            <tr>
                            <th></th>
                                <th>Fecha</th>
