...
class Creditos extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $data[$i]['monto'] = number_format($data[$i]['monto'], 0);
            $data[$i]['abonado'] = number_format($abonado, 0);
            $data[$i]['restante'] = number_format($restante, 0);
    ...
    public function buscar()
    {
        ...
        foreach ($data as $row) {
            ...
            $result['abonado'] = number_format($abonado, 0, '.', ''); 
            $result['restante'] = number_format($restante, 0, '.', '');
